...
CREATE TABLE prog_products.installations (
  installation_id SERIAL CONSTRAINT inst_primary  PRIMARY KEY,
...
ALTER TABLE prog_products.installations DROP CONSTRAINT inst_primary;
ALTER TABLE prog_products.installations ADD CONSTRAINT inst_primary PRIMARY KEY(installation_id, license_id);

INSERT INTO prog_products.installations (installation_id, installation_type, installation_date, deinstallation_date, license_id, price_for_help_with_installation, user_id, platform_id)
VALUES
    (3, 'manually', '2020-12-18', NULL, 2, 76.5, 1, 1);
