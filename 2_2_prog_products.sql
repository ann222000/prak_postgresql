...
--DROP TYPE IF EXISTS product_class_type;
...
CREATE TABLE prog_products.programming_products (
    ...
    product_class product_class_type NOT NULL
);
...
CREATE TABLE prog_products.installations (
	...
	license_id integer NOT NULL REFERENCES prog_products.licenses,
